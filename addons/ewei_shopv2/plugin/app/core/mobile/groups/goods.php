...
class Goods_EweiShopV2Page extends AppMobilePage 
{
	...
	public function get_spec() 
	{
		...
		$specArr = pdo_getall("ewei_shop_goods_spec", array( "goodsid" => $group_goods["gid"], "uniacid" => $_W["uniacid"] ), array( "id", "title" ), "", array( "id" => "asc" ));
		foreach( $specArr as $k => $v ) 
		{
			$specArr[$k]["item"] = pdo_getall("ewei_shop_goods_spec_item", array( "uniacid" => $_W["uniacid"], "specid" => $v["id"] ), array( "id", "specid", "title", "thumb" ), "", array( "id" => "asc" ));
		}
