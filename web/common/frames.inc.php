...
// App菜单
$we7_system_menu['phoneapp'] = array( // 没有显示？？
    'title' => 'APP',
    'icon' => 'wi wi-white-collar',
        ...
        'wxplatform' => array(
            ...
            'menu' => array(
                'system_account' => array(
                    ...
                    'sub_permission' => array( // 前面菜单进入页面中子链接需要的权限
                        array(
                            'title' => '公众号管理设置',
        ...
        'user' => array(
            ...
            'menu' => array(
                ...
                'system_user' => array(
                    ...
                    'permission_name' => 'system_user', // 控制器级别控制
                    'sub_permission' => array( // 前面菜单进入页面中子链接需要的权限
                        array(
                            'title' => '编辑用户',
                            'permission_name' => 'system_user_post', // 控制器内动作控制
                        ),
                        array(
                            'title' => '审核用户',
