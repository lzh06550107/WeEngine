...
/**
 * 上传到微信服务器文件先保存在本地服务器附件中，不会插入到core_attachment表中
 * @param $file 上传的文件信息
 ...
 * @param bool $auto_delete_local 是否删除本地资源
 * @return array|bool
 * @throws Exception
 */
 ...
 * @param int	$md5
 *							是否生成MD5验证码
 * @param int	$enforcement 是否开启强制模式
 *
 * @return array
 */
